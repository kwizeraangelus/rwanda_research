...
// Using lucide-react for modern, simple icons
...
const conferenceData = [
  {
    title: "National AI & Data Science Summit",
    date: "Dec 5-7, 2025",
    location: "Kigali Convention Centre",
    icon: Mic,
  },
  {
    title: "Sustainable Agriculture Tech Expo",
    date: "Jan 22-24, 2026",
    location: "Huye, Southern Province",
    icon: BookOpen,
  },
  {
    title: "Health Systems Innovation Forum",
    date: "Feb 10-11, 2026",
...
// Updated data structure with Unsplash images
const slidesData = [
  {
    images: [
      "https://images.unsplash.com/photo-1596791882855-83e3518e38d4?w=400&q=80", // Indoor vertical farm
      "https://images.unsplash.com/photo-1547496501-be6305a4175b?w=400&q=80", // Soil sample testing
      "https://images.unsplash.com/photo-1574549929235-98544d673167?w=400&q=80", // Hydroponic setup
    ],
    metadata: {
      name: "Dr. Uwamahoro J.",
  ...
  {
    images: [
      "https://images.unsplash.com/photo-1582215902181-425d996d9974?w=400&q=80", // Microscope slide/medical testing
      "https://images.unsplash.com/photo-1599052033000-ef807f0f0c05?w=400&q=80", // Smartphone UI showing health data
      "https://images.unsplash.com/photo-1580987395568-12d93e1074e5?w=400&q=80", // Blood sample under light
    ],
    metadata: {
  ...
  {
    images: [
      "https://images.unsplash.com/photo-1620023605417-fae372205510?w=400&q=80", // Digital security/biometric scan
      "https://images.unsplash.com/photo-1593508512951-eec2045bcf19?w=400&q=80", // Blockchain visualization
      "https://images.unsplash.com/photo-1544377726-218f260195e2?w=400&q=80", // Woman looking at data flow
    ],
    metadata: {
      name: "Ms. Umutoni G.",
  ...
  {
    images: [
      "https://images.unsplash.com/photo-1510464875960-e8372d825835?w=400&q=80", // Old film reels/archival
      "https://images.unsplash.com/photo-1577720580131-7e8c0e256860?w=400&q=80", // VR headset for viewing content
      "https://images.unsplash.com/photo-1524169575199-2319c5b2067d?w=400&q=80", // Traditional artifact
    ],
    metadata: {
      name: "Prof. Kamali S.",
...
// Data structure to handle mixed internal/external navigation
const navLinksData = [
...
// Simple Image Component (replaces next/image)
...
const SimpleImage: React.FC<SimpleImageProps> = ({ src, alt, className, style }) => (
            ...
            {navLinksData.map((link) => (
                <a
                    ...
                    onClick={(e) => {
                        toggle();
                        if (link.isInternal) {
                            // If it's an internal scroll link, use the smooth scroll function
                            e.preventDefault();
...
export default function HomePage() {
  ...
  // Function to handle smooth scrolling (Only used for internal links)
  const scrollToSection = (id: string) => {
    const element = document.getElementById(id);
    if (element) {
      window.scrollTo({
        top: element.offsetTop - 80, // Adjust for fixed nav height
        behavior: 'smooth',
      });
    }
  };
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex space-x-2 lg:space-x-6 items-center">
              {navLinksData.map((link) => (
                <a // Changed from button to a tag for direct navigation
                  key={link.name}
                  href={link.href}
                  onClick={(e) => {
                    if (link.isInternal) {
                        e.preventDefault(); // Prevent full page reload for internal scroll links
                        scrollToSection(link.href.substring(1));
                    }
                    // For isInternal=false links, it performs normal navigation (e.g., to /publications)
                  }}
                  // Using the original class names, preserving colors
      ...
      {/* Mobile Menu Overlay */}
      {/* Pass scrollToSection to the MobileMenu for internal links */}
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    ...
                    <p className="text-lg text-gray-600 mb-8 max-w-lg">
                        The national platform for discovery, publication, and collaboration. Access cutting-edge studies and connect with top researchers nationwide.
                    </p>
                    
                    {/* Call-to-Action Buttons - Changed to <a> for direct navigation */}
      ...
      {/* Retained ID as a fallback, but primary nav now links externally */}
      <section id="publications" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-center text-gray-600 mb-12">
                A selection of the most impactful and groundbreaking work currently on the hub.
            </p>
      ...
      <section className="py-16 bg-[#4a772e] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full max-w-5xl mx-auto rounded-xl overflow-hidden shadow-2xl relative pb-[56.25%] h-0">
                <iframe
                    src={VIDEO_EMBED_URL}
                    title="3 Examples of Technology and Innovation Transforming Health Care in Rwanda"
                    frameBorder="0"
      ...
      {/* ── ABOUT & FOOTER (Combined for simplicity) ── */}
      {/* Retained ID for internal scrolling from old code (e.g., Home link) */}
      <footer id="about" className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            {/* Quick Links - Changed buttons to <a> for direct navigation */}
            <div>
            ...
            {/* Legal - Changed placeholder hrefs to likely paths */}
            <div>
